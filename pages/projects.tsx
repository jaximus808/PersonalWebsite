...
import { Calendar, Star, ExternalLink, ArrowRight } from "lucide-react";
...
const ProjectsPage: React.FC<ProjectsPageProps> = ({ auth }) => {
  ...
  const { page, totalPages, canGoBack, canGoForward, goForward, goBack, sliceItems } =
    usePagination(projects.length, PROJECTS_PER_PAGE);
  ...
  return (
    <div>
      ...
      <>
        ...
        {auth && showAdminPanel && (
          <div className="mb-12 bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl mx-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-white mb-2 font-medium">Short Description</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white mb-2 font-medium">Full Description</label>
                <textarea
              ...
              <div>
                <label className="block text-white mb-2 font-medium">Link Display Name</label>
                <input
                  type="text"
              ...
              {customDate === "true" && (
                <div>
                  <label className="block text-white mb-2 font-medium">Project Date</label>
                  <input
                    type="text"
                    value={projectDate}
        ...
        <div>
          <h1 className="text-5xl font-bold text-white mb-8 text-center mt-10">My Projects</h1>
          <div className="">
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 py-4 px-12">
              {sliceItems(projects).map((project) => (
                <Link
                  key={project.id}
                ...
                >
                  ...
                  {project.projectLinks && (
                    <div className="flex items-center text-white/70 mb-4">
                      ...
                      <span className="text-sm">{project.linkName || "View Links"}</span>
                    </div>
                  )}
