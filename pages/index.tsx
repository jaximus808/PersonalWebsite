          ...
          <div  className={` ${styles.textContainer} bg-white text-black pt-4   border-t-[1rem] border-[#f2f2f2]`}>
            ...
            <div className='grid md:grid-cols-2 w-full h-full py-4 relative left-1/2 translate-x-[-50%] gap-x-24'>
              ...
              <div className='w-full md:w-4/5 px-4 md:px-0 '>
                <br></br>
                <h2 className={`${styles.fontNormal}  font-meduim text-xl mt-5 md:text-left text-center` }><span>I'm Jaxon,</span> I am born and raised from Hawaii! I'm a CS + Math at WashU, and started learning to code during Covid. I like building cool projects with a focus on impact ⚒️  </h2>
                <br></br>
